...
import { FiLock, FiX, FiTag, FiChevronRight, FiChevronDown, FiTruck, FiPercent } from "react-icons/fi";
      ...
      <div className="hidden md:block">
        {loading ? (
          ...
          <button
            type="submit"
            disabled={belowMin}
            className="group w-full h-14 rounded-2xl text-[15px] font-semibold flex items-center justify-center gap-2.5 text-white bg-gradient-to-b from-primary to-primary-700 shadow-[0_6px_18px_-4px_rgba(27,94,32,0.45)] hover:shadow-[0_8px_22px_-4px_rgba(27,94,32,0.55)] hover:from-primary-600 hover:to-primary-800 active:scale-[0.99] transition-all disabled:opacity-50 disabled:shadow-none disabled:cursor-not-allowed"
          >
            <FiLock size={15} />
            Place Order
