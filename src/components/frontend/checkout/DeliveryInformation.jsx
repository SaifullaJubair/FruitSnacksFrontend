...
// text inputs (same height, radius, focus ring). menuPortal z-index kept at 999
// exactly as before so the menu still renders above the sticky column.
const selectStyles = {
...
const DeliveryInformation = ({
  ...
  return (
    <div className="bg-white rounded-2xl border border-secondary-100/70 shadow-[0_1px_3px_rgba(62,39,35,0.06)] overflow-hidden">
      {/* Header — accent rail + map-pin icon */}
