...
import ThemeFonts from "@/components/theme/ThemeFonts";
...
export default function ThemeStyleInjector({ theme }) {
  ...
  return (
    <>
      {/* The faces referenced by --brand-font / --brand-font-heading. Loaded here
          (not from globals.css) so only themed routes pay for them, and without
