...
// Client leaf for the `product_features` section. The data-fetch moved OUT of
// here into the server parent (ProductFeatures.jsx) — this file keeps only what
// genuinely needs the browser: the variation chips (useState swaps media+price),
// the Swiper media carousel, and the cart/wishlist actions. It receives
// `products` + `currency` as plain props and fetches nothing.
...
export default function ProductFeaturesList({ products = [], currency = "৳" }) {
