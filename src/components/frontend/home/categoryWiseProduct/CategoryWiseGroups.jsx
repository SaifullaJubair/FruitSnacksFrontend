...
// Client leaf — the per-category Swiper needs the browser. The category+product
// data is fetched by the server parent (CategoryWiseProduct.jsx) and passed in
// as `data`; this file fetches nothing.
