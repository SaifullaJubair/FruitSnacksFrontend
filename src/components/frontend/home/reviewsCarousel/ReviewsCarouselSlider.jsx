...
// Client leaf — Swiper needs the browser (DOM measurement, touch handlers).
// The reviews themselves are fetched by the server parent (ReviewsCarousel.jsx)
// and passed in as props; this file fetches nothing.
...
const ReviewsCarouselSlider = ({ reviews = [], title }) => {
...
export default ReviewsCarouselSlider;
