...
// never touches the slider gets. At 5000 it silently hid every product priced
// above that: harmless for this shop today (nothing costs more than a few
// hundred), but this codebase is resold, and the sister shop had boots at 5200
// missing from its /shop entirely. PriceRangeFilter already renders its track
// from the backend's `maxPriceRange`, so the slider still ends at the real top
// price; this constant only decides the query sent before the customer has
// expressed a preference, and "no upper bound" is the honest answer to that.
//
